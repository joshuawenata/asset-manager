...
@section('js')
    <script defer src="{{ asset('js/datatable15.js') }}"></script>
@endsection
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="myTable15" class="display table w-full text-sm text-left text-gray-500 dark:text-gray-400" width="100%">
