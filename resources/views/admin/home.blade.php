            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="myTable10"
                            class="display table w-full text-sm text-left text-gray-500 dark:text-gray-400" width="100%">
                            ...
                            <tbody>
                                @foreach ($data as $index => $req)
                                    <tr>
                                        ...
                                        <td>
                                            {{-- DONE: ini masi error --}}
                                            <form action="{{ route('bookings.show', ['user' => 'admin', 'id' => $req->id]) }}"
                                                method="GET">
                                                @csrf
                                                <button type="submit"
