                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('approver.storeRequest') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-5 col-md-6"><input type="text" class="form-control rounded-md mt-2" readonly
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <textarea class="form-control rounded-md" id="purpose" name="purpose" required readonly>{{ $purpose }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-md-6"><input type="text" class="form-control rounded-md mt-2"
