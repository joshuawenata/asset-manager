                        ...
                        <form method="POST" action="{{ route('staff.storeAssetExcel') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-10">
                                ...
                                <div class="col-md-6">
                                    <input id="excel" 
                                        type="file"
                                        class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 @error('excel') is-invalid @enderror"
                                        name="excel"
                                        required
                                        autocomplete="excel"
                                        autofocus>
