                ...
                <form method="POST" action="{{ route('store-location') }}">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control rounded-md" id="location-name" name="location-name"
                            ...
                            <tbody>
                                @foreach ($data as $index => $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td class="flex space-x-2 align-middle items-center">
                                            <form action="{{ url('edit-location') }}" method="post" class="flex items-center">
                                                @csrf
                                                <input type="hidden" name="location_id" value="{{ $item->id }}">
                                                <input type="text" id="location_name" name="location_name" required class="item-center rounded-md">
                                            ...
                                            <form action="{{ url('delete-location') }}" method="post" class="flex items-center">
                                                @csrf
                                                <input type="hidden" name="location_id" value="{{ $item->id }}">
