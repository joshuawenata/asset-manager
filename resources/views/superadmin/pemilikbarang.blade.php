            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('createNewPemilikBarang') }}">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Pemilik Barang Baru</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="new-pemilik-barang" class="col-form-label">{{ __('Nama Pemilik Barang') }}</label>
                            <input type="text" class="form-input w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 " id="new-pemilik-barang" name="new-pemilik-barang"
                                autocomplete="new-pemilik-barang" autofocus>
                        </div>
                        <div id="box2">
                            <select class="form-input w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400  mb-3" name="division-id" id="division-id">
